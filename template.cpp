...
// {
// #ifdef _WIN32
// 	HWND hApp = FindWindow( NULL, WINDOW_NAME );
...
// 	if ( argc != 7 )
// 	{
// 		std::cout << "Wrong number of cmd arguments suppied (" << argc-1 << "), 6 are needed.:" << std::endl;
// 		std::cout << "lens.zmx image.exr samplesperframe framecount filename focusdistance" << std::endl;
// 		system( "pause" );
// 		return 0;
// 	}
...
// #ifdef ADVANCEDGL
// #ifdef FULLSCREEN
// 	window = SDL_CreateWindow( WINDOW_NAME, 100, 100, SCRWIDTH, SCRHEIGHT, SDL_WINDOW_FULLSCREEN | SDL_WINDOW_OPENGL );
// #else
// 	window = SDL_CreateWindow( WINDOW_NAME, 100, 100, SCRWIDTH, SCRHEIGHT, SDL_WINDOW_SHOWN | SDL_WINDOW_OPENGL );
// #endif
...
// #else
// #ifdef FULLSCREEN
// 	window = SDL_CreateWindow( WINDOW_NAME, 100, 100, SCRWIDTH, SCRHEIGHT, SDL_WINDOW_FULLSCREEN );
// #else
// 	window = SDL_CreateWindow( WINDOW_NAME, 100, 100, SCRWIDTH, SCRHEIGHT, SDL_WINDOW_SHOWN );
// #endif
